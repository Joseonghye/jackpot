...
public class TalkPage : NotePage {
    RectTransform rect;
    ...
    private void Awake()
    {
        rightPage = transform.parent.parent.GetChild(2).GetChild(1).gameObject;
    ...
    public override void Init()
    {
        ...
        //루프 노드 설정
        XmlNodeList nodelist = doc.SelectSingleNode("Note/Talk/Clue[@DefaultState='on']").ChildNodes;

        foreach (XmlNode node in nodelist)
        {

            string str_id = node.SelectSingleNode("id").InnerText;
